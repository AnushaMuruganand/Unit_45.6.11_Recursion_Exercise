...
function longest(words, i=0, longestWordsLength=0) {

  if (i === words.length) return longestWordsLength;
  longestWordsLength = Math.max(words[i].length, longestWordsLength);
  return longest(words, i + 1, longestWordsLength);
...
function revString(str, i = 0, reverseStr = "") {
  ...
  if (i >= str.length) return reverseStr;
